    ...
    <div className="min-h-screen bg-[#EDF0E0] flex flex-col">
      ...
      <main className="flex-1 w-full flex flex-col items-center py-8 pt-24">
        <div className="w-full max-w-md bg-white rounded-xl shadow p-8 mt-8 min-h-[350px] flex flex-col justify-center">
          <h1 className="text-2xl font-bold text-[#405B35] mb-6 text-center">Paiement Par Orange Money</h1>
          {processing ? (
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                <label className="block font-semibold mb-1" htmlFor="phone">Numéro Orange Money *</label>
                <input id="phone" type="tel" className="w-full border rounded px-3 py-2" required />
              </div>
              <div>
                <label className="block font-semibold mb-1" htmlFor="password">Mot de passe Orange Money *</label>
...
export default PaymentOrangeMoney;
